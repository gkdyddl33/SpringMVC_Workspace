...
$(function () {
	...
	$(".product-quicview").on("click",function(e){
		...
		console.log(product_id);		// product_id를 안다면, 모든 상품정보도 가져올 가능성이 있다..
												// 해당 product_id를 선택했을 때 해당 번호의 상세정보가 쫙 나온다는 것..
		...
		// 이미지
		$(".quickview_pro_img img").attr({// 이미지 안에 있는 img의 이미지 교체
		...
		$(".quickview_pro_des .detail").html(detail);	// 상세내용
